...
/// https://github.com/ios-sample-code/SimpleTunnel/blob/master/SimpleTunnelServices/FilterUtilities.swift
...
//        let hostname = FilterUtilities.getFlowHostname(flow: flow)
//
...
//        guard let browserFlow : NEFilterBrowserFlow = flow as? NEFilterBrowserFlow, let url = browserFlow.url, let hostname = url.host, flow is NEFilterBrowserFlow
//            else { return "" }
//        return hostname
//    }
//
...
//        let content: String
//        do {
//            content = try String(contentsOf: infoURL as URL, encoding: String.Encoding(rawValue: NSUTF8StringEncoding) ?? <#default value#>)
//        }
//        catch {
...
//        }
//
//        let contentArray = content.split(separator: "<br/>")
...
//
//            if ruleArrayCount > 1 {
//                actionString = String(ruleArray[1])
//            }
//            if ruleArrayCount > 2 {
//                redirectKey = String(ruleArray[2])
//            }
//            if ruleArrayCount > 3 {
//                remediateKey = String(ruleArray[3])
//            }
//            if ruleArrayCount > 4 {
//                remediateButtonKey = String(ruleArray[4])
//            }
//
//
//            urlRules[urlString] = [
